// java chapter-6/TicTacToe.java

import java.util.Arrays;
import java.util.Scanner;
public class TicTacToe {
    private static final char EMPTY_BOX = ' ';
    private static final char PLAYER_ONSES_SYMBOL = 'X';
    ...
    private void askForUserNames(){
        ...
        System.out.println("Who are playing with?");
    ...
    private void askForManeuver() {
        ...
        if(whoIsPlaying().equals(playerOne)){
            gameBoard[row][col] = PLAYER_ONSES_SYMBOL;
    ...
    private boolean validateInput(int row, int col) {
        ...
        if(row < 0 || col < 0 || row > 2 || col > 2) {
            System.out.println("The position is off the bonus " + "off the board, try again");
